<template>
  <div class="flex items-center justify-evenly h-16 bg-primary w-full fixed bottom-0">
    <router-link to="/">
    ...
    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg"
      class="cursor-pointer" @click="logout"
    >
